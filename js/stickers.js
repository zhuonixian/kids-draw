...
function face(kind) {
    const y = ['car', 'train', 'rocket', 'balloon', 'berry', 'sun', 'mushroom', 'flower', 'planet', 'bigstar', 'moon', 'drum', 'piano', 'notecloud'].includes(kind) ? 78 : 73;
...
function light(color) {
    return color === '#74B9FF' ? '#DDF3FF' : '#FFF8E7';
}
